...
Use the getRandomFlavors function and new arrays below to do the following:
  ...
  2. Randomly pi ck flavors from all four arrays
...
function getRandomFlavors(array1, array2, array3, array4){
 ...
 let randomFlavors = [array1[Math.floor(Math.round(Math.random()*array1.length))], array2[Math.floor(Math.round(Math.random()*array2.length))], array3[Math.floor(Math.round(Math.random()*array3.length))], array4[Math.floor(Math.round(Math.random()*array4.length))]];
  return randomFlavors;
}

console.log('Task 9', getRandomFlavors(originalFlavors, newFlavors, seasonalFlavors, regionalFlavors));
